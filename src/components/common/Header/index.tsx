...
function Header() {
    return (
        <header className="flex justify-between p-4 shadow-lg mb-2">
            ...
            <div className="relative group invisible lg:visible order-2">
                ...
                <div className="max-h-0 overflow-hidden group-hover:max-h-[300px] transition-all duration-[0.5s] delay-0 absolute w-48 right-0">
